...
(custom-set-variables
 ...
 '(org-capture-templates
      '(("j" "Journal for today" entry (file+datetree "~/Dropbox/personal/daytoday.org")
	 "* %?\n%U\n")
	("J" "Journal for someday" entry (file+datetree+prompt "~/Dropbox/personal/daytoday.org")
	 "* %?\n%U\n")
	("t" "Add Task for today" entry (file+datetree "~/Dropbox/personal/daytoday.org")
	 "* TODO %? \n DEADLINE:%t \n")
	("T" "Add Task for someday" entry (file+datetree+prompt "~/Dropbox/personal/daytoday.org")
	 "* TODO %? \n DEADLINE:%^t \n")
